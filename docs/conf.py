...
htmlhelp_basename = 'MuPPI_datasetdoc'
...
latex_documents = [
    (master_doc, 'MuPPIDataset.tex', u'MuPPIDataset Documentation',
     u'Alexis Prod Homme', 'manual'),
]
...
man_pages = [
    (master_doc, 'MuPPIDataset', u'MuPPIDataset Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MuPPIDataset', u'MuPPIDataset Documentation',
     author, 'MuPPIDataset', 'One line description of project.',
     'Miscellaneous'),
]
