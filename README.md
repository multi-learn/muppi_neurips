...
[Release Download](https://github.com/<utilisateur>/<repo>/releases/tag/0.0.1) or from last Artefact in Action Folow Build (file dist-muppi-neurips)[https://github.com/multi-learn/muppi_neurips/]
