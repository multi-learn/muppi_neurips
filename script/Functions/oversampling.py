...
dataset = h5py.File(H5_DIR + "MuPPI_2025_14view{}_EMF.hdf5".format(suffix_light), 'r')
...
views_resampled, Labels_resampled = SMOTE(sampling_strategy={0: labels_count[0], 1: labels_count[1],
                                                             2: labels_count[2]}).fit_resample(views, dataset["Labels"][()])
...
dataset_resampled = h5py.File(H5_DIR + "MuPPI_2025_14view{}_EMF_oversampled.hdf5".format(suffix_light), 'w')
